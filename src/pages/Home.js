    ...
    <div>
      <div className='flex flex-col p-5 m-10 md:flex-row'>
         <div className="flex flex-col justify-center order-2 md:w-1/2 md:pr-8 md:order-1">
            <h1 className="mb-4 text-5xl font-bold text-left">GoBridge</h1>
            <p className="text-3xl text-left gray-600 text-">GoBridge is a member of the non-profit organization BridgeFoundry.  At GoBridge we build bridges to educate underrepresented communities to teach technical skills and to foster diversity in Go. <br/> Contact us at support@gobridge.org with any questions, issues or request you may have.
            </p>
         </div>
